...
> *Component Location:* [`chatbot/engines/question_engine.py`](chatbot/engines/question_engine.py)  
> *Authoritative Question Bank:* [`engine/QuestionEngine/questions.json`](engine/QuestionEngine/questions.json)  
> *Protocols & Contracts:* [`chatbot/interfaces.py`](chatbot/interfaces.py)  
> *State Representation:* [`chatbot/state/medha_state.py`](chatbot/state/medha_state.py)
